...
/**
 * Servlet implementation class RedireccionarBiblioteca
 */
@WebServlet("/redireccionarBiblioteca")
public class RedireccionarBiblioteca extends HttpServlet {
    ...
    public RedireccionarBiblioteca() {
        super();
