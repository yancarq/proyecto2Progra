...
/**
 * Servlet implementation class RedireccionamientoAdministrarJuegos
 */
@WebServlet("/redireccionamientoAdministrarJuegos")
public class RedireccionamientoAdministrarJuegos extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		try{
			if(bean!=null){
				 RequestDispatcher requestDispatcher = request.getRequestDispatcher("AdministrarJuegos.jsp");  
    ...
    public RedireccionamientoAdministrarJuegos() {
        super();
