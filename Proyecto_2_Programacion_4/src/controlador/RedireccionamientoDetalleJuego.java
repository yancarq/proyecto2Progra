...
/**
 * Servlet implementation class DetalleJuego
 */
@WebServlet("/redireccionamientoDetalleJuego")
public class RedireccionamientoDetalleJuego extends HttpServlet {
    ...
    public RedireccionamientoDetalleJuego() {
        super();
