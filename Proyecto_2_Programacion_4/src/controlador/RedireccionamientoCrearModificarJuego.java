...
/**
 * Servlet implementation class RedireccionamientoCrearModificarJuego
 */
@WebServlet("/redireccionamientoCrearModificarJuego")
public class RedireccionamientoCrearModificarJuego extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		try{
			if(bean!=null){
				 RequestDispatcher requestDispatcher = request.getRequestDispatcher("CrearModificarJuego.jsp");  
    ...
    public RedireccionamientoCrearModificarJuego() {
        super();
