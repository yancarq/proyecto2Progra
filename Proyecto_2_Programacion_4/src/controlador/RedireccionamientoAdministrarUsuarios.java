...
/**
 * Servlet implementation class RedireccionamientoAdministrarUsuarios
 */
@WebServlet("/redireccionamientoAdministrarUsuarios")
public class RedireccionamientoAdministrarUsuarios extends HttpServlet {
private static final long serialVersionUID = 1L;
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		try{
			if(bean!=null){
				 RequestDispatcher requestDispatcher = request.getRequestDispatcher("AdministrarUsuarios.jsp");  
    ...
    public RedireccionamientoAdministrarUsuarios() {
        super();
